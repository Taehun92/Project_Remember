...
<h4>로그인/회원가입 페이지</h4>
<div>로그인 페이지는 심플한 UI를 제공하여 누구나 쉽게 접근 할 수 있게 하였으며,</div>  
<div>금색의 포인트색상으로 고급스러움을 표현하였습니다.</div>
...
<h4>상세 페이지, 모달창</h4>
<div>
게시글 클릭 시, 모달창을 통해 본문 및 이미지들과 상세 페이지가 나오게 구현,</div>
<div>댓글 및 대댓글 작성이 가능하며 댓글에서는 멘션 기능을 사용해 특정 인원을 언급 할 수 있습니다.
</div>
</div>
<br />
<br />
...
<div>
사이드바에서 게시글 등록 클릭 시, 게시글 등록 전용 모달창이 나오게 구현,</div>
<div>이미지는 최대 5장 첨부 가능, 공개범위를 설정 가능하며, 본문에서 멘션과 태그 기능을 사용하여 특정인원을 언급 할 수 있습니다.
</div>
</div>
<br />
<br />
...
<div>컴포넌트를 조금 더 세분화하여 만들었다면, 완성도 있는 SNS서비스가 되었을 것이라 생각합니다. </div>
<div>최초 설계시 원하는 방향과, 이에따른 DB를 만들어 놓고 작업을 진행 하였으나</div>
<div>중간에 컬럼 추가 삭제 하는 경우도 발생하였으며 </div>
